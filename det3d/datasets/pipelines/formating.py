...
class Reformat(object):
    ...
    def __call__(self, res, info):
        ...
        if 'voxels' in res["lidar"]:
            ...
            if "sweep_order" in res["lidar"].keys():
                data_bundle.update(sweep_order=res["lidar"]["sweep_order"])
            if "lidar_path" in res["lidar"].keys():
                data_bundle.update(lidar_path=res["lidar"]["lidar_path"])
            if "gt_dict_origin" in res["lidar"].keys():
                data_bundle.update(gt_dict_origin=res["lidar"]["gt_dict_origin"])
