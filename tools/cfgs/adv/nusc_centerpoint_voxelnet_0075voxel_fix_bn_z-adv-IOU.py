...
# adv ---------------------------------------
# python dist_test.py ../configs/adv/nusc_centerpoint_voxelnet_0075voxel_fix_bn_z-adv-IOU.py --checkpoint  ../work_dirs/nusc_centerpoint_voxelnet_0075voxel_fix_bn_z/centerpoint_voxel_1440-epoch_20.pth --speed_test
...
IOU = dict(
    ...
    strategy='',
    # strategy='light',
    # save_dir=r'/home/jqwu/Datasets/Outputs/centerpoint-adv/IOU_CoorAdjust',
    save_dir=r'/Data4T/Outputs/centerpoint-adv/IOU_iter',
)
