...
PointAttach = dict(
    ...
    Lamda='N',
    # strategy='random',
    # strategy='gradient_sorted',
    strategy='gradient_sorted_removePoints-init_0.00005',
    # strategy='gradient_sorted_not_add',
    # strategy='gradient_sorted_not_add-small_grad',
    # strategy='gradient_sorted-not_add-voxelize_permutation',
    # strategy='gradient_sorted-not_add-voxelize_permutation-limitH',
    # strategy='gradient_sorted_iouLoss',
    # strategy='gradient_sorted_iouLoss+loss',
    attach_rate=0.1,
    # save_dir=r'/home/jqwu/Datasets/Outputs/centerpoint-adv/Point_Attach',
    save_dir=r'/Data4T/Outputs/centerpoint-adv/Point_Attach',
)
