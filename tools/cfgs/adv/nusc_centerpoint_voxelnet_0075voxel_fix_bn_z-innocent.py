...
# python dist_test.py ../configs/adv/nusc_centerpoint_voxelnet_0075voxel_fix_bn_z-innocent.py --work_dir ../work_dirs/ADV/innocent/trainset --checkpoint  ../work_dirs/nusc_centerpoint_voxelnet_0075voxel_fix_bn_z/centerpoint_voxel_1440-epoch_20.pth --speed_test

# 测试
is_innocent_eval = True

is_adv_eval = False
adv_eval_dir = r'/home/jqwu/Datasets/Outputs/centerpoint-adv/FGSM-debug/eps_0.02'
...
adv_flag = is_adv['is_FGSM'] or is_adv['is_PGD'] or is_adv['is_IOU']
# FGSM
FGSM = dict(
    Epsilon=0.02,
