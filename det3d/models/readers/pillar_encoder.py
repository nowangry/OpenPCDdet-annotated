...
class PillarFeatureNet(nn.Module):
    ...
    def forward(self, features, num_voxels, coors):
        ...
        mask = get_paddings_indicator(num_voxels, voxel_count, axis=0)  # 得到
        mask = torch.unsqueeze(mask, -1).type_as(features)
        features *= mask

        # Forward pass through PFNLayers
        #  Stacked Pillars是如何变成Learned Features
        # P*N*D(30000 x 20 x 9)->P*N*C(30000 x 20 x 64)-> P*C(30000*64)
