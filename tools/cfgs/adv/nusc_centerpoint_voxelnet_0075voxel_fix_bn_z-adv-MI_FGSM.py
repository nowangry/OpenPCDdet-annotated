...
# python dist_test.py ../configs/adv/nusc_centerpoint_voxelnet_0075voxel_fix_bn_z-adv-PGD_CoorAdjust.py  --checkpoint  ../work_dirs/nusc_centerpoint_voxelnet_0075voxel_fix_bn_z/centerpoint_voxel_1440-epoch_20.pth --speed_test
...
MI_FGSM = dict(
    ...
    # L_norm='L1',
    L_norm='L2',
    # save_dir=r'/home/jqwu/Datasets/Outputs/centerpoint-adv/MI_FGSM',
    save_dir=r'/Data4T/Outputs/centerpoint-adv/MI_FGSM',
)
