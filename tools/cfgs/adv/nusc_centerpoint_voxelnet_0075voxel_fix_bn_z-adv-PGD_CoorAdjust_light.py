...
# adv ---------------------------------------
# python dist_test.py ../configs/adv/nusc_centerpoint_voxelnet_0075voxel_fix_bn_z-adv-PGD_CoorAdjust_light.py  --checkpoint  ../work_dirs/nusc_centerpoint_voxelnet_0075voxel_fix_bn_z/centerpoint_voxel_1440-epoch_20.pth --speed_test
...
PGD_CoorAdjust_light = dict(
    random_start=False,
    eps=0.20,
    eps_iter=0.01,
    num_steps=5,
    save_dir=os.path.join(outputs_dir_root, 'centerpoint-adv/PGD_CoorAdjust_light')
)
